...
CREATE TABLE TeamName {
  ...
  FOREIGN KEY TeamID REFRENCES Team (ID)
};
...
CREATE TABLE Game {
  ...
  FOREIGN KEY HomeTeam REFRENCES Team (ID),
  FOREIGN KEY AwayTeam REFRENCES Team (ID)
};
...
CREATE TABLE Event {
  ...
  FOREIGN KEY Batter REFRENCES Player (ID),
  FOREIGN KEY Pitcher REFRENCES Player (ID)
};
